...
#!perl
#line 29
    eval 'exec D:\Fira\Kuliah\KULIAH TEKNIK INFORMATIKA\SEMESTER 3\Desain dan Pemrograman Web\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'D:\Fira\Kuliah\KULIAH TEKNIK INFORMATIKA\SEMESTER 3\Desain dan Pemrograman Web\xampp\perl\bin\perl.exe';
